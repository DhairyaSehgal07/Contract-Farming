  ...
  const button = (
    <Comp
      ...
      className={cn(
        ...
        className,
        // Consumer classes (e.g. min-h-11) must not expand the icon rail or show label crumbs.
        "group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:min-h-8! group-data-[collapsible=icon]:max-h-8!"
      )}
      {...props}
    />
  )
